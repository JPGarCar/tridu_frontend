...
const DataUpload = () => {
  ...
  const [parseResult, setparseResult] =
    useState<Papa.ParseResult<object> | null>(null);
  ...
  const handleDataTypeSelected = (dataType: {
    name: string;
            ...
            {activeStep == 0 ? (
              ...
              dataType != null ? (
                <UploadCSVFileStep
                  ...
                  columnHeaders={Object.keys(dataType.schema.fields)}
                  handleSuccess={handleDataUploadSuccess}
                />
              ) : (
                <>Error...</>
              )
              ...
              dataType != null ? (
                <ReviewDataStep
                  ...
                  handleSuccess={handleNext}
                  handleFailure={handleServerErrors}
                />
              ) : (
                <>Error... </>
              )
              ...
              <StepCardLayout
                instructions={
                  "All done, feel free to go back to the dashboard!"
                }
              >
                <Container>
                  Need to do it again?
