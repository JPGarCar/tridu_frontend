                    ...
                    <CardContent>
                        {
                            activeStep > steps.length
                                ? <StepCardLayout instructions={"All done! The participant has been created!"}>
                                    <Button type={"button"} onClick={handleFinish}>Go to Participant</Button>
                                </StepCardLayout>
                                : activeStep == 0
                                    ? <CreateUserStep handelSuccess={handleUserCreation} />
                                    : activeStep  == 1
                                        ? <SelectRaceStep handleSuccess={handleRaceSelect} />
                                        : (raceIdSelected && newUserId) ? <CreateParticipantStep raceId={raceIdSelected} userId={newUserId} handleSuccess={handelParticipantCreation} /> : <>Error...</>
                        }
                    </CardContent>
                </Card>
            </Container>
